...
<body>
    ...
    <section class="login-section">
        <div class="login-card" data-motion-animate="fadeInUp" data-motion-duration="0.8">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <!-- Remember Me -->
                <div class="flex items-center mb-4" data-motion-animate="fadeInUp" data-motion-duration="0.8"
                    data-motion-delay="0.3">
                    <label for="remember_me" class="checkbox-label">
                        <input id="remember_me" type="checkbox"
                            class="text-teal-500 border-gray-600 rounded shadow-sm focus:ring-0 focus:ring-offset-0"
                            name="remember">
                ...
                <div class="flex flex-col items-center space-y-4">
                    <button type="submit" class="login-button" data-motion-animate="fadeInUp"
                    ...
                    @if (Route::has('password.request'))
                        <a class="action-link" href="{{ route('password.request') }}" data-motion-animate="fadeInUp"
                    ...
                    <a class="action-link" href="/register" data-motion-animate="fadeInUp" data-motion-duration="0.8"
