...
<body class="font-sans antialiased">
    ...
    <section class="slider-section container mx-auto px-4 relative z-10">
        <div class="latest-posts-slider">
            ...
            <div>
                ...
                <div class="slide-caption">
                    ...
                    <p class="text-sm mt-2 text-gray-300">Posted on {{ $post->published_at->format('F j, Y') }} by {{ $post->user->name }} | {{ $post->views }} Views</p>
                </div>
            </div>
            @endforeach
        </div>
    ...
    <section id="posts" class="container mx-auto px-4 py-16 relative z-10">
        <h2 class="text-4xl font-bold text-center mb-12 text-white">All Posts</h2>
        <div class="posts-grid">
            ...
            <div class="post-card">
                ...
                <div class="p-4">
                    ...
                    <h3 class="text-lg font-semibold text-white mt-2 mb-2">{{ $post->title }}</h3>
                    <p class="text-gray-400 text-sm mb-4">{{ $post->description }}</p>
                    <p class="text-xs text-gray-500 mb-4">Posted on {{ $post->published_at->format('F j, Y') }} by {{ $post->user->name }} | {{ $post->views }} Views</p>
                    <a href="/post/{{ $post->slug }}" class="text-cyan-400 hover:text-cyan-300 text-sm font-medium">Read More</a>
                </div>
            </div>
            @endforeach
        </div>
                            ...
                            const postCard = `
                                <div class="post-card">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <h3 class="text-lg font-semibold text-white mt-2 mb-2">${post.title}</h3>
                                        <p class="text-gray-400 text-sm mb-4">${post.description}</p>
                                        <p class="text-xs text-gray-500 mb-4">Posted on ${new Date(post.published_at).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })} by ${post.user.name} | ${post.views} Views</p>
                                        <a href="/post/${post.slug}" class="text-cyan-400 hover:text-cyan-300 text-sm font-medium">Read More</a>
                                    </div>
                                </div>
                            `;
